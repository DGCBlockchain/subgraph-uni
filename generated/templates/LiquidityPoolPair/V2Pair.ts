...
export class V2Pair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class V2Pair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class V2Pair extends ethereum.SmartContract {
  static bind(address: Address): V2Pair {
    return new V2Pair("V2Pair", address);
  }
  ...
  burn(to: Address): V2Pair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new V2Pair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<V2Pair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new V2Pair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): V2Pair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new V2Pair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<V2Pair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
